...
extension NSAssetsCLI.Schemes {
    struct SyncPostActions: AsyncParsableCommand {
        static let configuration = CommandConfiguration(
            commandName: "sync-post-actions",
            abstract: "Sync managed NSAssets post-test actions into configured schemes"
        )
        ...
        func run() async throws {
            ...
            let executor = SyncPostActionsCommandExecutor(
                ...
                configLoader: NSAssetsConfigLoader(fileSystem: fileSystem),
